...
public interface DescriptorGenerator {
     ...
     */
    DescriptorGenerator add(String name, String description);
     ...
     * @throws IllegalArgumentException if name is null or blank
     */
    DescriptorGenerator add(String name, String description, JsonFieldType type);
     ...
     * @throws IllegalArgumentException if name is null or blank
     */
    DescriptorGenerator add(String name, String description, JsonFieldType type, boolean optional);
     ...
     * @return This generator instance for method chaining
     */
    DescriptorGenerator add(Descriptor descriptor);
